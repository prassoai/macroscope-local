...
print_installation_completion() {
  ...
  printf "  ${CYAN}/macroscope:codereview${RESET}           ${DIM}# Run a code review${RESET}\n"
  printf "  ${CYAN}/macroscope:autoloop${RESET}             ${DIM}# Review and fix until no issues are found, up to 5 rounds${RESET}\n"
  echo ""
